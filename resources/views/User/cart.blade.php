...
<div class="infor-container-right">
    ...
    <div class="row mb-3 p-3 border rounded bg-light" style="min-height: 180px; display: flex; align-items: center;">
        <div class="col-md-3 d-flex align-items-center justify-content-center">
            @php
                $imageList = data_get($room, 'file_anh', []);
                $randomImage = count($imageList) > 0 ? $imageList[array_rand($imageList)] : 'default.jpg';
            @endphp

            <img src="{{ asset('room_img/' . trim($randomImage)) }}" alt="Room Image" class="img-fluid rounded" style="object-fit: cover;">
                </div>
                <div class="col-md-4">
